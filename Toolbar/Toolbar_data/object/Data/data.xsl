...
<PROJECT SID="-1" WS="http://www.smartface.biz" dateLastResourceUpdated="010101000000" AppID="0" AppName="Smartface Demo" CID="0" Ver="1.0.0" ScreenW="320" ScreenH="480" Dpi="163" FacebookAppUID="" FacebookAppSecret="" TwitterConsumerKey="" TwitterConsumerSecret="">
	...
	<MENUS>
		<MENU ID="D864061B-A8C8-4C71-81DC-28000E69CA51" Nm="Menu1">
			<DATA>
				<PRM Nm="Bind" Val="" />
			</DATA>
			<ITM Nm="Property1" IconResName="" />
			<ITM Nm="Property2" IconResName="" />
			<ITM Nm="Property3" IconResName="" />
			<ITM Nm="Property4" IconResName="" />
			<ITM Nm="Property5" IconResName="" />
		</MENU>
	</MENUS>
	<GLOBALEVENTS>
